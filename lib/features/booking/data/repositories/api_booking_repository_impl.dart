...
class ApiBookingRepositoryImpl implements BookingRepository {
  ...
  Future<Booking> createBooking({
    ...
    return Booking(
      ...
      totalPrice: response.paidTotal,
      organizerTotal: response.totalAmount,
      platformFeeAmount: response.platformFeeAmount,
      buyerTotal: response.buyerTotal,
      currency: 'EUR',
  ...
  Booking _mapBookingDto(BookingListItemDto b) {
    ...
    return Booking(
      ...
      activityId: b.eventId?.toString() ?? '',
      quantity: quantity,
      totalPrice: b.buyerTotal ?? b.grandTotal ?? b.totalAmount ?? 0.0,
      organizerTotal: b.totalAmount,
